...
class Movie():
  ...
  Attributes: 
    ...
    poster_image_url: A string containing a URL for an image file with the movie's poster art.
    trailer_youtube_url: A string containing a URL for the movie's trailer.
    more_url: A string containing a URL for more information about the movie at IMDB.

  """

  def __init__(self, movie_title, release_date, movie_storyline, poster_image, trailer_youtube, more_link):
